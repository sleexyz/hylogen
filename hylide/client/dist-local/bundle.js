...
/******/ 	__webpack_require__.p = "http://localhost:5678";
/******/
...
"use strict";
var SoundCloudAudio = __webpack_require__(176);
...
var audioAgain = null;
var bands = { low: 0.0, mid: 0.0, upper: 0.0, high: 0.0 };
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  initializeAudioSoundCloud: async function (url, initPlaying) {
    ...
    var { accessToken } = await (await fetch("https://sleexyz-sc_access_token.web.val.run/")).json();

    var scPlayer = this.scPlayer = new SoundCloudAudio(accessToken);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Program__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AudioControls__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ErrorText__ = __webpack_require__(94);
...
var App = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  ...
  componentDidMount: function () {
    ...
    window.setTimeout(function () {
      _this.setState({ bannerClass: "hidden" });
    }, 3000);
  },
  connectToServer: function () {
    ...
    wsConn.onclose = function () {
      ...
      window.setTimeout(_this2.connectToServer, 1000);
    };
  ...
  toggleShow() {
    this.setState(function (prev) {
      return { showControls: !prev.showControls };
    });
  },
  render: function () {
    var buttonText = this.state.showControls ? "hide" : "show";
    var audioControlClassName = this.state.showControls ? "unhiddenFast" : "hiddenFast";

    var error = this.state.error ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "div",
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__ErrorText__["a" /* default */], { text: this.state.errorText })
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { id: "banner", className: this.state.bannerClass },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { id: "title" },
          "Hylogen"
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "button",
        { onClick: this.toggleShow, id: "hideButton" },
        buttonText
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: audioControlClassName },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__AudioControls__["a" /* default */], { initialState: "usermedia" })
      ),
      error,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Program__["a" /* default */], { startAnimating: true,
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(App, null), document.getElementById("entry"));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_soundplayer_components__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_soundplayer_components___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react_soundplayer_components__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Audio__ = __webpack_require__(56);
...
var SC = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  propTypes: {
    initPlaying: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].bool
  },
  getDefaultProps() {
    return {
      initPlaying: false
  ...
  getInitialState() {
    ...
    var defaulturl = localStorage.getItem("scurl") || "https://soundcloud.com/tennysonmusic/xyz" || "https://soundcloud.com/wearesilkenwood/klypht-spiraling-chasm" || "https://soundcloud.com/tennysonmusic/angus-julia-stone-for-you" || "https://soundcloud.com/herzeloyde/deception" || "https://soundcloud.com/aslamin/strannoe-chuvstvo";
    return {
      loading: false,
  ...
  async startPlaying() {
    if (!__WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer) {
      this.setState({ loading: true });
      await __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].initializeAudioSoundCloud(this.state.url, this.props.initPlaying);
      __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer.play();
      // Hack to get around some weirdness with the soundcloud player:
      await new Promise(function (resolve) {
        return setTimeout(resolve, 2000);
      });
      __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer.pause();
      await new Promise(function (resolve) {
        return setTimeout(resolve, 2000);
      });
  ...
  update() {
    var val = __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer.audio.currentTime / (__WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer.duration / 100);
  ...
  onSubmit(e) {
    ...
    __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer.resolve(this.state.url, function (track) {
      /* console.log(track); */
  ...
  render: function () {
    var buttonVal = this.state.playing ? "[pause]" : "[play]";
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_soundplayer_components__["Progress"], { innerStyle: {},
          soundCloudAudio: __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].scPlayer,
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { value: this.state.url,
            style: { width: "40vw" },
...
var UserMedia = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  componentWillMount() {
    __WEBPACK_IMPORTED_MODULE_3__Audio__["a" /* default */].initializeAudioUserMedia();
  },
  render: function () {
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  propTypes: {
    initialState: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].string
  },
  getDefaultProps() {
    return {
      initialState: "sc"
  ...
  render() {
    ...
    var component = this.state.state === "sc" ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(SC, { initPlaying: this.state.initPlaying }) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(UserMedia, null);

    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "div",
      { className: "audioControls" },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "inputPicker" }),
      component
    );
  }
}));
...
module.exports = function () {
  ...
  this.emitBeat = function () {
    var now = new Date() / 1000; // in seconds
    var diff = now - state.last; // in seconds
    state.last = now;
    state.freq = 1 / diff;

    var phaseDiff = state.phase - 0; // we expect phase to be zero
    state.phase = Math.fmod(state.phase - phaseDiff, 1);
  };

  // getPhase. To be called once over 1/srate.
  this.getPhase = function (srate) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_osc__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_osc___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_osc__);
...
/* harmony default export */ __webpack_exports__["a"] = (new function () {
  ...
  this.getInstance = function () {
    if (this.singleton === undefined) {
      this.singleton = new __WEBPACK_IMPORTED_MODULE_0_osc___default.a.WebSocketPort({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Audio__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__OscPort__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BeatMatcher__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BeatMatcher___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__BeatMatcher__);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  propTypes: {
    vsSource: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].string,
    fsSource: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].string.isRequired,
    width: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].number,
    height: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].number,
    withOSC: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].bool.isRequired,
    animation: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].bool
  },
  getDefaultProps() {
    return {
  ...
  componentDidMount() {
    ...
    var state = this.state_ = {
      ...
      time0: new Date() / 1000,
      audioCallback: null,
      beatMatcher: new __WEBPACK_IMPORTED_MODULE_4__BeatMatcher___default.a(),
      textures: [],
      videoTexture: null
    };
    ...
    canvas.onclick = function () {
      return state.beatMatcher.emitBeat();
    };
    ...
    state.audioCallback = __WEBPACK_IMPORTED_MODULE_2__Audio__["a" /* default */].addCallback(function (bands) {
    ...
    if (this.props.withOSC) {
      var instance = __WEBPACK_IMPORTED_MODULE_3__OscPort__["a" /* default */].getInstance();

      // TODO: handle cleanup of callback
      instance.on("message", function (msg) {
        var addr = parseInt(msg.address.slice(1));
        var val = msg.args[0];
        state.osc[addr] = val;
      });
    }
  ...
  draw() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__Audio__["a" /* default */].video.playing) {
      updateTexture(state.videoTexture, __WEBPACK_IMPORTED_MODULE_2__Audio__["a" /* default */].video);
    }
  ...
  componentWillUnmount() {
    cancelAnimationFrame(this.state_.animationFrameRequest);
    __WEBPACK_IMPORTED_MODULE_2__Audio__["a" /* default */].removeCallback(this.state_.audioCallback);
  },
  render() {
    var _this = this;

    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("canvas", { ref: function (ref) {
        return _this.canvas = ref;
      },
      className: "program",
...
var _Icons = __webpack_require__(21);
...
var _soundcloudAudio = __webpack_require__(28);
