...
instance Veccable 2 where copy x = vop2pre' "vec2" x x
instance Veccable 3 where copy x = vop3pre' "vec3" x x x
instance Veccable 4 where copy x = vop4pre' "vec4" x x x x
